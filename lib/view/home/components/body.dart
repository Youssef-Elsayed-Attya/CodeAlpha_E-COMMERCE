...
import 'package:sneakers/services/store.dart';
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final products = snapshot.data!.docs.map(
          (doc) {
            return ProductModel(
                name: doc[AppConstantsText.kProductName],
                model: doc[AppConstantsText.kProductModel],
                price: doc[AppConstantsText.kProductPrice],
                imgAddress: doc[AppConstantsText.kProductImage],
                modelColor: Color(doc[AppConstantsText.kProductColor]),
                description: doc[AppConstantsText.kProductDescription]);
          },
        ).toList();
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: FadeAnimation(
                              ...
                              child: Row(
                                children: [
                                  Text(model.name.substring(0,20),
