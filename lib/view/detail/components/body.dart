...
class details extends State<DetailsBody> {
  ...
  Image img() {
    if (widget.model.name == 'NIKE') {
      return Image(image: AssetImage(widget.model.imgAddress));
    } else {
      return Image(image: NetworkImage(widget.model.imgAddress));
    }
  }
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(widget.model.imgAddress),
                  fit: BoxFit.cover,
